...
class Array_Icons_Widget extends WP_Widget {
	...
	function array_icons_widget() {
		...
		$this->WP_Widget( 'array-icons-widget', __( 'Array Social Icons Widget', 'array-toolkit'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<div class="icons-widget">
			...
			<div id="icons" class="<?php echo $instance['icons_shape']; ?>">
				...
				<?php if ( $vimeo_icon ) { ?>
					<a href="<?php echo $instance['vimeo_icon']; ?>" class="vimeo-icon" title="<?php _e( 'Vimeo', 'array-toolkit' ); ?>"><i class="icon-play-circled"></i></a>
				<?php } ?>
				...
				<?php if ( $youtube_icon ) { ?>
					<a href="<?php echo $instance['youtube_icon']; ?>" class="youtube-icon" title="<?php _e( 'YouTube', 'array-toolkit' ); ?>"><i class="icon-youtube-play"></i></a>
				<?php } ?>

				<?php if ( $pinterest_icon ) { ?>
					<a href="<?php echo $instance['pinterest_icon']; ?>" class="pinterest-icon" title="<?php _e( 'Pinterest', 'array-toolkit' ); ?>"><i class="icon-pinterest-circled"></i></a>
				<?php } ?>

				<?php if ( $github_icon ) { ?>
					<a href="<?php echo $instance['github_icon']; ?>" class="github-icon" title="<?php _e( 'Github', 'array-toolkit' ); ?>"><i class="icon-github-circled"></i></a>
				<?php } ?>
